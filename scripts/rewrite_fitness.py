# -*- coding: utf-8 -*-
"""重写 DETAIL.fitness：从大段文字 → 可视化计划表（周计划卡片+每日动作表+强度进阶表+饮食清单+追踪表）"""
import sys, io, re
...
if i < 0:
    print('MISS DETAIL.fitness'); sys.exit()
# 结束位置：下一个 "\nDETAIL." 或 "\n//" 或 "\n\n"
j = c.find('\nDETAIL.', i+10)
if j < 0:
    j = c.find('\n\n', i+10)
print('替换范围:', i, j, '长度', j-i)

new = """DETAIL.fitness = '<h2>💪 健身方案 · 8周腹肌专项</h2><p class="detail-subtitle">跳绳 · 俯卧撑 · 拉力绳 · 平板支撑</p>'+

'<div class="callout warn" style="border-left:4px solid #e11d48"><strong>🎯 目标：练出腹肌（8周专项）</strong><br>'
'<strong>你的情况</strong>：170cm / 59kg · 能摸出腹肌轮廓但有赘肉 → 体脂率约 15-18%（瘦胖子）｜目标体脂 ≤12-15%<br>'
'<strong>你的基础</strong>：俯卧撑 60 个 / 平板支撑 2分半 → 可直接上强度<br>'
'<strong>核心策略</strong>：跳绳控脂 + 腹肌增厚 + 俯卧撑变式 + 蛋白质提升（<b>不能靠饿</b>——已偏瘦，饿会掉肌肉）</div>'+

'<h3>💡 三个关键认知</h3>'+
'<div class="ex-list">'+
'<div class="ex-item c1"><span class="ex-n">腹肌是「厨房里练出来的」</span></div>'+
'<div class="ex-item c2"><span class="ex-n">局部减脂不存在（只能整体降）</span></div>'+
'<div class="ex-item c3"><span class="ex-n">看腰围，不看体重</span></div>'+
'</div>'+
'<p style="font-size:11px;color:var(--text2);margin:-4px 0 12px">体脂率决定腹肌可见度；练腹只让腹肌变厚，消不掉覆盖的脂肪；体重可能不变（肌肉增加）但腰围会降。</p>'+

'<h3>📅 周训练计划表</h3>'+
'<div class="wk-plan">'+
'<div class="wk-day cardio"><div class="wk-w">周一</div><div class="wk-i">🪢</div><div class="wk-t">跳绳HIIT</div><div class="wk-m">+ 腹肌A<br>35-40min</div></div>'+
'<div class="wk-day strength"><div class="wk-w">周二</div><div class="wk-i">💪</div><div class="wk-t">俯卧撑变式</div><div class="wk-m">+ 拉力绳背<br>35min</div></div>'+
'<div class="wk-day rest"><div class="wk-w">周三</div><div class="wk-i">🚶</div><div class="wk-t">恢复日</div><div class="wk-m">快走30min<br>拉伸</div></div>'+
'<div class="wk-day cardio"><div class="wk-w">周四</div><div class="wk-i">🪢</div><div class="wk-t">跳绳HIIT</div><div class="wk-m">+ 腹肌B<br>35-40min</div></div>'+
'<div class="wk-day strength"><div class="wk-w">周五</div><div class="wk-i">🎗️</div><div class="wk-t">拉力绳全身</div><div class="wk-m">+ 平板变式<br>35min</div></div>'+
'<div class="wk-day cardio"><div class="wk-w">周六</div><div class="wk-i">🏃</div><div class="wk-t">稳态有氧</div><div class="wk-m">跳绳/快走<br>40min</div></div>'+
'<div class="wk-day rest"><div class="wk-w">周日</div><div class="wk-i">😴</div><div class="wk-t">完全休息</div><div class="wk-m">泡沫轴<br>拉伸</div></div>'+
'</div>'+
...
'<tr><td>平板支撑 3 组 + 爆发俯卧撑</td><td>3×90秒 / 3×8-10</td></tr>'+
...
'<div class="ex-list">'+
'<div class="ex-item c1"><span class="ex-n">热量 2300-2500 kcal</span><span class="ex-s">轻缺口</span></div>'+
'<div class="ex-item c2"><span class="ex-n">蛋白质 106-130g/天</span><span class="ex-s">1.8-2.2g/kg</span></div>'+
'<div class="ex-item c3"><span class="ex-n">碳水循环（训练日55%/休息日40%）</span><span class="ex-s">控脂</span></div>'+
'<div class="ex-item c4"><span class="ex-n">戒含糖饮料/夜宵/精制糖</span><span class="ex-s">最快见效</span></div>'+
'<div class="ex-item c1"><span class="ex-n">补水≥2.5L + 柠檬水</span><span class="ex-s">兼顾结石预防</span></div>'+
'<div class="ex-item c2"><span class="ex-n">睡眠 7-8h</span><span class="ex-s">控皮质醇</span></div>'+
'</div>'+
...
'<h3>🧬 增肌原理（打底知识）</h3><div class="highlight-box"><p><strong>三个变量缺一不可：</strong>①机械张力 ②代谢压力(泵感) ③肌肉损伤(休息时修复)。每组8-15次是增肌黄金区间。</p></div>'+
...
print('OK DETAIL.fitness 已重写为可视化版本')
