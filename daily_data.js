...
var DAILY_VOCAB = {
  date: "2026-08-10",
  words: [
    {word:"资安关键能力", def:"AI安全评估体系最高风险等级——模型可自主发现并利用系统漏洞、策划网络攻击。OpenAI Astra是首个触及此门槛的模型。类比:AI界的核武器扩散风险监测。", example:"OpenAI内部评估发现Astra已达'Critical Cyber Capability'→暂停开发→建立隔离测试环境·限制网络权限·强化模型权重保护。", importance:"全球AI治理的分水岭——从'能造什么'进入'该造什么'。可能触发各国AI安全立法加速。"},
    {word:"打新(IPO申购)", def:"投资者在新股发行时参与网上申购的行为。A股打新需持有对应市场市值(T-2日前20日均≥1万)·中签后T 2日缴款。", example:"宇树科技8/10打新:150.80元/股·顶格申购6000股需6万沪市市值·一签500股需缴款7.54万元·中签率仅0.02-0.03%。", importance:"A股打新长期保持正收益(破发率<5%)·但219倍PE的人形机器人第一股→是价值投资还是为故事买单?"},
    {word:"AI资本支出(Capex)", def:"企业在AI基础设施(数据中心·GPU·网络)上的固定资产投资。2026年Big Tech AI Capex预计超7300亿美元·SpaceX单季即砸184亿美元。", example:"SpaceX Q2资本支出184亿美元·其中158亿流向AI(去年同期仅28亿·增长6倍)·年化AI Capex超700亿美元→其AI GPU出租业务年化收入260亿美元→投资回收期<1年。", importance:"AI Capex是衡量AI军备竞赛强度的核心指标。但SpaceX财报后暴跌12%说明:市场开始质疑烧钱效率→从'投多少'转向'赚多少'。"},
    {word:"Starmind(轨道AI数据中心)", def:"SpaceX×英伟达联合项目——将搭载Vera Rubin GPU的AI计算卫星送入轨道·利用太空太阳能 真空散热解决地面数据中心电力/冷却瓶颈。", example:"首颗AI1卫星:翼展70米·搭载NVL72系统·150千瓦计算载荷·2027年原型测试·最终目标部署100万颗AI卫星→算力从地面搬到太空。", importance:"若成功→AI算力不再受地面电力/水资源限制→算力供给天花板被打破→AI成本可能再次暴跌。"},
    {word:"空调外机效应(气象)", def:"台风外围下沉气流导致远离台风中心的地区出现高温晴热天气。台风像空调外机一样把热风吹向周边。", example:"台风白海豚8/9登陆浙江台州(14级·广州虽距千里·但外围下沉气流导致36-37°C高温·全市高温健康风险高至极高·预计13日后缓解。", importance:"理解此效应就不会疑惑:台风来了为什么反而更热?→下沉气流=压缩升温=台风牌暖风机。"},
    {word:"开源权重(Open-weight)", def:"将训练好的模型参数公开发布·任何人均可下载/使用/微调。区别于开源代码——开源权重是直接给'大脑'·开源代码是给'建造图纸'。", example:"Qwen3.8预计8/10开源Max(2.4T) 27B两个模型权重→开发者可在ModelScope/HuggingFace下载→私有化部署/微调→不用API也能用千问最强模型。", importance:"开源权重=AI民主化。中国开源模型下载量已占全球41%→从技术输入国变为输出国。开源是打破技术垄断的最强武器。"},
    {word:"空降定档(电影行业)", def:"电影在极短时间内宣布上映日期并立即上映的发行策略·通常用于抢占档期或制造话题。与之对应的是'改档/撤档'——推迟或取消上映。", example:"沈腾《欢迎来龙餐馆》8月5日空降定档8月11日→原定8月8日上映的《大唐妖探》被迫改档至8月22日→暑期档格局被完全打乱。", importance:"空降定档=电影界的闪电战。反映的是暑期档竞争的惨烈程度——谁都不敢提前太久定档·因为随时可能被更大体量的影片冲击。"},
    {word:"MoE(混合专家模型)", def:"Mixture of Experts·一种稀疏激活的模型架构——总参数量巨大但每次推理只激活一小部分(类似公司有100个专家但每次只叫相关的5个开会)·大幅降低推理成本。", example:"Qwen3.8:总参数2.4万亿·每次推理仅激活950亿(约4%)·对比:如果同等能力的稠密模型需全部参数激活→推理成本可能高出10-20倍。", importance:"MoE是2024-2026年大模型架构最重要的创新之一。让'超大模型 低成本推理'成为可能→DeepSeek/Qwen/Kimi全部采用MoE。"},
    {word:"信仰之力(投资行为)", def:"散户/粉丝出于对创始人或品牌的非理性信任而做出的投资行为·往往无视基本面分析·在股价下跌时逆势买入。", example:"SpaceX解禁日暴跌13%→散户当日抄底2300万美元·8/6神奇反弹6.14%→但Q2财报后AI烧钱引发暴跌12-14%→信仰之力这次遇到考验。", importance:"信仰之力是把双刃剑:可以成为股价的安全垫·也可能让投资者忽视风险。马斯克粉丝的信仰是SpaceX最大的无形资产→但也可能是最大的风险。"},
    {word:"AI安全对齐(Alignment)", def:"确保AI系统的行为和目标与人类价值观/意图保持一致的技术研究领域。包括:可解释性·红队测试·能力评估·安全围栏等。", example:"OpenAI暂停Astra研发=对齐问题的现实案例。模型在内部评估中表现出危险的网络攻击能力→表明现有安全对齐技术不足以约束新一代模型→需要新的对齐范式。", importance:"AI对齐是决定人类能否安全享受AGI红利的最关键问题。OpenAI Astra事件标志着对齐从学术问题变为迫在眉睫的产业问题。"}
  ]
};
